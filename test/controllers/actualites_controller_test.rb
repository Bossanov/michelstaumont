...
class ActualitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actualite" do
    assert_difference('Actualite.count') do
      post actualites_url, params: { actualite: { body: @actualite.body, date: @actualite.date, lieu: @actualite.lieu, title: @actualite.title } }
    end
  ...
  test "should update actualite" do
    patch actualite_url(@actualite), params: { actualite: { body: @actualite.body, date: @actualite.date, lieu: @actualite.lieu, title: @actualite.title } }
