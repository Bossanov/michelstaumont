...
class PaniersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create panier" do
    assert_difference('Panier.count') do
      post paniers_url, params: { panier: { statut: @panier.statut, totalprice: @panier.totalprice, typeenvoi: @panier.typeenvoi } }
    end
  ...
  test "should update panier" do
    patch panier_url(@panier), params: { panier: { statut: @panier.statut, totalprice: @panier.totalprice, typeenvoi: @panier.typeenvoi } }
